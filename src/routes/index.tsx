...
function Home() {
  ...
  return (
    <>
      <Seo
        title="Vitala Global — Better everyday health, with humanity"
        description="Vitala Global is a family of trusted consumer healthcare brands — vitamins, skincare, oral care, sleep and children's nutrition — present in 38 markets."
        jsonLd={{
            ...
            <Reveal delay={0.1} className="lg:col-span-8">
              ...
              <div className="mt-12 grid gap-8 md:grid-cols-2">
                <p className="text-pretty text-base text-muted-foreground md:text-lg">
                  Vitala Global was founded to bring clinical-grade consumer healthcare to households that demand more — better ingredients, better evidence, better design. Our brands sit in the bathrooms, kitchens and travel bags of millions across 38 markets.
                </p>
                <p className="text-pretty text-base text-muted-foreground md:text-lg">
        ...
        <div className="mx-auto grid max-w-[1400px] gap-16 px-6 lg:grid-cols-2 lg:px-10">
          <Reveal>
            <div className="overflow-hidden rounded-md">
              <img src={lab} alt="Vitala research lab" loading="lazy" className="h-full w-full object-cover" />
            </div>
          </Reveal>
